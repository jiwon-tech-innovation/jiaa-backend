...
import io.github.jiwontechinnovation.user.repository.PersonalityRepository;
...
public class PersonalityInitializer {
    ...
    @Bean
    public CommandLineRunner initPersonalities(PersonalityRepository personalityRepository) {
        return args -> {
            if (!personalityRepository.existsById("betain")) {
                personalityRepository.save(new Personality(
                        "betain",
                        "베타인",
                        "상냥하고 사려 깊은 친구 캐릭터",
                        """
            ...
            if (!personalityRepository.existsById("alpain")) {
                personalityRepository.save(new Personality(
                        "alpain",
                        "알파인",
                        "까칠한 소꿉친구 매스가키 캐릭터",
            ...
            if (!personalityRepository.existsById("clementine")) {
                personalityRepository.save(new Personality(
                        "clementine",
                        "클레맨타인",
                        "논리적이고 객관적인 정보 전문가",
